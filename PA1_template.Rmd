...
```{r}
myDataClean <- subset(myData,myData$steps != "NA")
```

1. Histogram of the total number of steps taken each day

First of all, we sum the steps for each day with the help of the `plyr` package.
...
1. Create a new factor variable in the dataset with two levels (_weekday_ and _weekend_) indicating whether a given date is a weekday or weekend day.
